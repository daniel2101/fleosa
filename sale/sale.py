...
class sale_order(osv.osv):
  ...
  - The 'Invoice based on deliveries' choice is used to create an invoice during the picking process."""),
        ...
        'amount_untaxed': fields.float("Untaxed Amount", digits_compute= dp.get_precision('Sale Price'),
            multi='sums', help="The amount without tax."),
        'amount_tax': fields.float("Taxes", digits_compute= dp.get_precision('Sale Price'),
            multi='sums', help="The tax amount."),
        'amount_total': fields.float("Total", digits_compute= dp.get_precision('Sale Price'),
